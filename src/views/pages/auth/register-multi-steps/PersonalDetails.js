...
const StepPersonalDetails = ({ handleNext, handlePrev , theme}) => {
  ...
  return (
    <>
      ...
      <Grid container spacing={5}>
        ...
        <Customtypography variant="h5">Personal Details</Customtypography>
        ...
        <FormControl fullWidth sx={{ mb: 4 }}>
            ...
            <FormControl fullWidth sx={{ mb: 4 }}>
              ...
              <Grid item xs={12}>
              <Box sx={{ mb: 4 , display: 'flex', justifyContent: 'center' }}>
              <Customtypography sx={{fontSize:20}}>List of Programme(s) Applied</Customtypography>
              {/* <Typography sx={{ color: 'text.secondary' }}>Enter Your Personal Information</Typography> */}
              </Box>
              <Box sx={{ mb: 4 , display: 'flex', justifyContent: 'center' }}>
